...
namespace XFramework.DataTable
{
    ...
    public interface IDataTableManager
    {
        ...
        /// 
        /// </summary>
        /// <param name="dataTableAssetName">数据表资源名称。</param><param name="userData">用户自定义数据。</param>
        ...
        /// 
        /// </summary>
        /// <typeparam name="T">数据表行的类型。</typeparam><param name="name">数据表名称。</param>
        /// <returns>
        /// 是否存在数据表。
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <param name="dataRowType">数据表行的类型。</param><param name="name">数据表名称。</param>
        /// <returns>
        /// 是否存在数据表。
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <typeparam name="T">数据表行的类型。</typeparam><param name="text">要解析的数据表文本。</param>
        /// <returns>
        /// 要创建的数据表。
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <param name="dataRowType">数据表行的类型。</param><param name="text">要解析的数据表文本。</param>
        /// <returns>
        /// 要创建的数据表。
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <typeparam name="T">数据表行的类型。</typeparam><param name="name">数据表名称。</param><param name="text">要解析的数据表文本。</param>
        /// <returns>
        /// 要创建的数据表。
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <param name="dataRowType">数据表行的类型。</param><param name="name">数据表名称。</param><param name="text">要解析的数据表文本。</param>
        /// <returns>
        /// 要创建的数据表。
        /// </returns>
