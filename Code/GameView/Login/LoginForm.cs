...
namespace GameView
{
    public class LoginForm : FairyGuiForm
    {
        ...
        protected override void OnInit(object userData)
        {
            ...
            m_VersionText = window.GetChild("tf_Version").asTextField;
            m_NoticeButton = window.GetChild("btn_Notice").asButton;
            m_AccountButton = window.GetChild("btn_Account").asButton;
            m_NoticePanel = window.GetChild("notice").asCom;
            m_LoginPanel = window.GetChild("login").asCom;
