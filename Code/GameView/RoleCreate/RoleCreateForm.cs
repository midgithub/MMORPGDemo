...
namespace GameView
{
    public class RoleCreateForm : FairyGuiForm
    {
        ...
        protected override void OnInit(object userData)
        {
            ...
            m_WarriorButton = window.GetChild("btn_warrior").asButton;
            m_MagicButton = window.GetChild("btn_magic").asButton;
            m_ArcherButton = window.GetChild("btn_archer").asButton;
            m_CreateRoleButton = window.GetChild("btn_CreateRole").asButton;
            m_RoleNamePanel = window.GetChild("RoleNamePanel").asCom;
            m_DiceButton = m_RoleNamePanel.GetChild("btn_Dice").asButton;
            m_NameInput = m_RoleNamePanel.GetChild("ipt_RoleName").asTextInput;
            m_RoleInfoPanel = window.GetChild("RoleInfoPanel").asCom;
        ...
        protected override void OnOpen(object userData)
        {
            ...
            RoleCreateFormParams data = (RoleCreateFormParams)userData;
            if (data == null)
            {
