...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class NetworkComponent : GameFrameworkComponent
    {
        ...
        private void OnNetworkConnected(object sender, XFramework.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<NetworkConnectedEventArgs>().Fill(e));
        }

        private void OnNetworkClosed(object sender, XFramework.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<NetworkClosedEventArgs>().Fill(e));
        }

        private void OnNetworkSendPacket(object sender, XFramework.Network.NetworkSendPacketEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<NetworkSendPacketEventArgs>().Fill(e));
        }

        private void OnNetworkMissHeartBeat(object sender, XFramework.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<NetworkMissHeartBeatEventArgs>().Fill(e));
        }

        private void OnNetworkError(object sender, XFramework.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<NetworkErrorEventArgs>().Fill(e));
        }

        private void OnNetworkCustomError(object sender, XFramework.Network.NetworkCustomErrorEventArgs e)
        {
