...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        private void OnPlaySoundSuccess(object sender, XFramework.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, XFramework.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, XFramework.Sound.PlaySoundUpdateEventArgs e)
        {
        ...
        private void OnPlaySoundDependencyAsset(object sender, XFramework.Sound.PlaySoundDependencyAssetEventArgs e)
        {
        ...
        private void OnLoadSceneSuccess(object sender, XFramework.Scene.LoadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnLoadSceneFailure(object sender, XFramework.Scene.LoadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneSuccess(object sender, XFramework.Scene.UnloadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneFailure(object sender, XFramework.Scene.UnloadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
