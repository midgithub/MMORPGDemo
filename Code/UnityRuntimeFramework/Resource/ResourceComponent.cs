...
namespace UnityRuntimeFramework.Resource
{
    ...
    public sealed partial class ResourceComponent : GameFrameworkComponent
    {
        ...
        private void OnResourceInitComplete(object sender, XFramework.Resource.ResourceInitCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceInitCompleteEventArgs>().Fill(e));
        }

        private void OnVersionListUpdateSuccess(object sender, XFramework.Resource.VersionListUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<VersionListUpdateSuccessEventArgs>().Fill(e));
        }

        private void OnVersionListUpdateFailure(object sender, XFramework.Resource.VersionListUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<VersionListUpdateFailureEventArgs>().Fill(e));
        }

        private void OnResourceCheckComplete(object sender, XFramework.Resource.ResourceCheckCompleteEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceCheckCompleteEventArgs>().Fill(e));
        }

        private void OnResourceUpdateStart(object sender, XFramework.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateStartEventArgs>().Fill(e));
        }

        private void OnResourceUpdateChanged(object sender, XFramework.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateChangedEventArgs>().Fill(e));
        }

        private void OnResourceUpdateSuccess(object sender, XFramework.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateSuccessEventArgs>().Fill(e));
        }

        private void OnResourceUpdateFailure(object sender, XFramework.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<ResourceUpdateFailureEventArgs>().Fill(e));
        }

        private void OnResourceUpdateAllComplete(object sender, XFramework.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
