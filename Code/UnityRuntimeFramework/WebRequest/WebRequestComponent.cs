...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        private void OnWebRequestStart(object sender, XFramework.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<WebRequestStartEventArgs>().Fill(e));
        }

        private void OnWebRequestSuccess(object sender, XFramework.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<WebRequestSuccessEventArgs>().Fill(e));
        }

        private void OnWebRequestFailure(object sender, XFramework.WebRequest.WebRequestFailureEventArgs e)
        {
