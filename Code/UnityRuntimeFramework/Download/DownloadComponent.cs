...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DownloadComponent : GameFrameworkComponent
    {
        ...
        private void OnDownloadStart(object sender, XFramework.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadStartEventArgs>().Fill(e));
        }

        private void OnDownloadUpdate(object sender, XFramework.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadUpdateEventArgs>().Fill(e));
        }

        private void OnDownloadSuccess(object sender, XFramework.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ReferencePool.Acquire<DownloadSuccessEventArgs>().Fill(e));
        }

        private void OnDownloadFailure(object sender, XFramework.Download.DownloadFailureEventArgs e)
        {
